            ...
            <section id="Thumbnail" class="relative">
                <div class="swiper h-fit">
                    <div class="swiper-wrapper w-full h-fit">
                        <div
                            class="swiper-slide !w-[310px] !h-[350px] flex shrink-0 overflow-hidden"
                        >
                            <img
                                src="{{ Storage::url($carStore->thumbnail) }}"
                ...
                <div
                    class="px-4 flex justify-between items-center transform translate-y-1/2 absolute bottom-0 z-10 w-full"
                >
                    @if($carStore->is_open)
                    <p
                    ...
                    @endif
                    <div
                        class="flex items-center w-fit rounded-full border border-[#E9E8ED] p-[6px_12px] bg-white"
                    >
                        ...
                        <p class="text-sm leading-[21px] text-[#909DBF]">
                            <span class="font-semibold text-[#270738]"
                                >4.8</span
                            >
                            <span>(145,394)</span>
                        </p>
                ...
                <div id="title" class="flex flex-col gap-[6px]">
                    <div class="flex items-center gap-1">
                        ...
                        <div class="w-[22px] h-[22px] flex shrink-0">
                            <img
                                src="{{ asset('assets/images/icons/verify.svg') }}"
                                alt="verified"
                            />
                        </div>
                    </div>
                ...
                <div id="Menus" class="flex flex-col gap-5">
                    <div class="tab-link-btns flex items-center gap-2">
                        <button
                            ...
                            onclick="openPage('about-tab', this)"
                            id="defaultOpen"
                        >
                            <h2>About</h2>
                        </button>
                    ...
                    <div class="tabs-contents">
                        <div id="about-tab" class="tabcontent flex hidden">
                            <div class="flex flex-col gap-5">
                                <p class="leading-[28px]">
                                    Shayna Xtra Wash selalu memberikan pelayanan
                                    extra terbaik untuk kendaraan anda sehingga
                                ...
                                <div id="Service" class="flex flex-col gap-2">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{ Storage::url($carService->icon) }}"
                                                    alt="icon"
                                                />
                                            </div>
                                            <div class="flex flex-col h-fit">
                                                ...
                                                <p
                                                    class="text-sm leading-[21px] text-[#909DBF]"
                                                >
                                                    Top Rated Service
                                                </p>
                                            </div>
                        ...
                        <div id="reviews-tab" class="tabcontent flex hidden">
                            <div class="flex flex-col gap-[14px] w-full">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="{{ asset('assets/images/photos/photo1.png') }}"
                                    ...
                                    <div class="flex flex-col gap-1 w-full">
                                        ...
                                        <p
                                            class="text-sm leading-[24px] text-[#909DBF]"
                                        >
                                            Tempatnya enak buat santai sembari
                                            cuci mobil jadi makin mengkilap
                                        </p>
                                    </div>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="{{ asset('assets/images/photos/photo2.png') }}"
                                            class="w-full h-full object-cover"
                                            alt="photo"
                                        />
                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="{{ asset('assets/images/photos/photo3.png') }}"
                                            class="w-full h-full object-cover"
                                            alt="photo"
                                        />
                                    </div>
                        ...
                        <div id="contact-tab" class="tabcontent flex hidden">
                            <div class="flex flex-col gap-5">
                                <p class="leading-[28px]">
                                    Jika Anda memiliki pertanyaan silahkan
                                ...
                                <div id="Contact" class="flex flex-col gap-2">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{ asset('assets/images/icons/contact.svg') }}"
                                                    alt="icon"
                                                />
                                            </div>
                                            <div class="flex flex-col h-fit">
                                        ...
                                        <a
                                            href="tel:{{ $carStore->phone_number }}"
                                            class="appearance-none font-semibold text-sm leading-[21px] hover:underline text-[#FF8E62]"
                                            >Call Now</a
                                        >
                                    </div>
                ...
                <div class="relative p-4 px-9 w-full max-w-2xl max-h-full">
                    ...
                    >
                        <div class="w-full h-[150px] flex shrink-0">
                            <img
                                src="{{ Storage::url($carService->photo) }}"
                                class="w-full h-full object-cover"
                                alt="thumbnail"
                            />
                        </div>
                        <div class="flex flex-col px-4 gap-4">
                            <div class="flex items-center justify-between">
                                <div class="flex flex-col gap-[2px]">
                                    <p
                                        class="font-semibold text-lg leading-[27px]"
                                    >
                                        {{ $carService->name }}
                                    </p>
                                    <p
                                ...
                                <p
                                    class="rounded-full p-[6px_10px] bg-[#DFB3E6] w-fit font-bold text-xs leading-[18px]"
                                >
                                    POPULAR
                                </p>
                            </div>
